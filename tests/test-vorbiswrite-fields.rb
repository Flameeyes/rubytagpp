# Simple test of saving data from and reading it to an Ogg Vorbis
# (via fields)
...
savefile = TagLib::Ogg::Vorbis::File.new(cvt.path)
...
readfile = TagLib::Ogg::Vorbis::File.new(cvt.path)
